...
*/
/*
ALTER USER 'root'@'localhost:3306' IDENTIFIED WITH mysql_native_password BY '271140'; 
*/

/* criar usuário específico para aplicação agenda */
CREATE USER 'root'@'localhost:3306tb_pessoa' IDENTIFIED WITH mysql_native_password BY '271140'; 
